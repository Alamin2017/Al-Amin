...
AzureDevops:Playwright project
...
- script: npx playwright test TestHooksL_E2E.spec.js
  ...
  default:
    - step:
        ...
        script:
          - npm ci        
          # - Run the test cases 
          - npx playwright test DataParameter_E2E.spec.js
        artifacts:
         - playwright-report/index.html

AzureDevOps:Cypress project
